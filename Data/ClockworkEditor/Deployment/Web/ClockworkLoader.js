...
var ClockworkLoader = function(playerCanvas, spinner, width, height) {

  ClockworkLoader.instance = this;
...
ClockworkLoader.prototype.constructor = ClockworkLoader;

ClockworkLoader.prototype.initModuleObject = function() {

  Module = {

    arguments: ["-x", ClockworkLoader.instance.width.toString(), "-y", ClockworkLoader.instance.height.toString()],

    preRun:[function() {
      var loader = ClockworkLoader.instance;
    }],
