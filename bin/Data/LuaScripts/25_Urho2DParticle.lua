...
function CreateScene()
    ...
    local particleEffect = cache:GetResource("ParticleEffect2D", "Clockwork2D/sun.pex")
    ...
    local greenSpiralEffect = cache:GetResource("ParticleEffect2D", "Clockwork2D/greenspiral.pex")
