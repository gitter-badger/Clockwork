-- Clockwork2D physics Constraints sample.
...
function CreateScene()
    ...
    staticSprite.sprite = cache:GetResource("Sprite2D", "Clockwork2D/Box.png")
    ...
    staticSprite.sprite = cache:GetResource("Sprite2D", "Clockwork2D/Ball.png")
    ...
    staticSprite.sprite = cache:GetResource("Sprite2D", "Clockwork2D/Aster.png")
