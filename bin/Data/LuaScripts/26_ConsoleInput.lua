...
function Advance()
    if clockworkThreat > 0 then
        clockworkThreat = clockworkThreat + 1
        if clockworkThreat > 3 then
            EndGame("Clockwork has eaten you!")
            return
        end
    elseif clockworkThreat < 0 then
        clockworkThreat = clockworkThreat + 1
    elseif clockworkThreat == 0 and Random() < 0.2 then
        clockworkThreat = clockworkThreat + 1
    end

    if clockworkThreat > 0 then
        Print(clockworkThreatLevels[clockworkThreat] .. ".")
    end
