...
var CLOCKWORK_TOOL_BIN = platform_cli.CLOCKWORKTOOL_BIN;
...
var clockworktool = function (flags, opts) {
    ...
    return exec(CLOCKWORK_TOOL_BIN, flags, opts);
};
exports.clockworktool = clockworktool
...
exports.clockworkeditor = clockworkeditor

exports.newProject = function (output) {
  return clockworktool(["new", output], {output:true});
};
...
exports.editor = function () {
  return clockworkeditor(["-project", process.cwd()], {output:true});
};
...
exports.run = function (platform, opts) {
    ...
    var run = function () {
        ...
        case "web":
          ...
          case "mac":
              var open = require("open");
              open("Build/Mac-Build/ClockworkPlayer.app");
              break;
