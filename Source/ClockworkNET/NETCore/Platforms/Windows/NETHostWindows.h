...
class CLOCKWORK_API NETHostWindows : public NETHost
{
...
private:
    ...
    bool TPAListContainsFile(wchar_t* fileNameWithoutExtension, wchar_t** rgTPCExtensions, int countExtensions);
    void RemoveExtensionAndNi(wchar_t* fileName);
    void AddFilesFromDirectoryToTPAList(const wchar_t* targetPath, wchar_t** rgTPCExtensions, int countExtensions);
