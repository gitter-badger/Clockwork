...
bool CSManaged::Initialize()
{
    ...
    core->CreateDelegate("ClockworkNETEngine", "ClockworkEngine.ComponentCore", "CSComponentCreate", (void**) &CSComponentCreate_);
    core->CreateDelegate("ClockworkNETEngine", "ClockworkEngine.ComponentCore", "CSComponentApplyFields", (void**) &CSComponentApplyFields_);
    core->CreateDelegate("ClockworkNETEngine", "ClockworkEngine.NativeCore", "NETUpdate", (void**) &NETUpdate_);
