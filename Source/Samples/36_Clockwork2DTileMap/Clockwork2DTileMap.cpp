...
#include <Clockwork/Clockwork2D/TmxFile2D.h>
#include <Clockwork/Clockwork2D/TileMap2D.h>
#include <Clockwork/Clockwork2D/Drawable2D.h>

#include "Clockwork2DTileMap.h"

#include <Clockwork/DebugNew.h>

DEFINE_APPLICATION_MAIN(Clockwork2DTileMap)

Clockwork2DTileMap::Clockwork2DTileMap(Context* context) :
    Sample(context)
{
}

void Clockwork2DTileMap::Start()
{
...
void Clockwork2DTileMap::CreateScene()
{
    ...
    // Get tmx file
    TmxFile2D* tmxFile = cache->GetResource<TmxFile2D>("Clockwork2D/isometric_grass_and_water.tmx");
    if (!tmxFile)
        return;
...
void Clockwork2DTileMap::CreateInstructions()
{
    ResourceCache* cache = GetSubsystem<ResourceCache>();
...
void Clockwork2DTileMap::SetupViewport()
{
...
void Clockwork2DTileMap::MoveCamera(float timeStep)
{
...
void Clockwork2DTileMap::SubscribeToEvents()
{
    // Subscribe HandleUpdate() function for processing update events
    SubscribeToEvent(E_UPDATE, HANDLER(Clockwork2DTileMap, HandleUpdate));

    // Unsubscribe the SceneUpdate event from base class to prevent camera pitch and yaw in 2D sample
    UnsubscribeFromEvent(E_SCENEUPDATE);
}

void Clockwork2DTileMap::HandleUpdate(StringHash eventType, VariantMap& eventData)
{
