...
class CLOCKWORK_API Network : public Object, public kNet::IMessageHandler, public kNet::INetworkServerListener
{
    OBJECT(Network);
...
void CLOCKWORK_API RegisterNetworkLibrary(Context* context);
