...
public:
     ...
     *  If the operating system and UI cursors are both invisible, interaction with the Clockwork UI will be limited (eg: drag move / drag end events will not trigger).
