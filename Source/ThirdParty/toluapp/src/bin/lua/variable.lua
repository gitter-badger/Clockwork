...
-- Modified by Aster Jian and Joshua Nuttall for Clockwork
...
function classVariable:supcode ()
 ...
 local class = self:inclass()
    ...
    -- Clockwork: Fixed tolua++ bug, let it generate reference property's set code
