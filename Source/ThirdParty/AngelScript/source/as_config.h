...
// Modified by Joshua Nuttall and Skrylar for Clockwork
...
// Use the following command to determine predefined macros: echo . | g++ -dM -E -
	...
	// Windows
		...
		#define COMPLEX_RETURN_MASK (asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_ARRAY)
			...
			// Clockwork: also check for Clang version and use the same workaround 
	...
	// Android
		...
		#define COMPLEX_RETURN_MASK (asOBJ_APP_CLASS_DESTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_ARRAY)
			...
			#define AS_X86
			#undef AS_NO_THISCALL_FUNCTOR_METHOD
// Clockwork - Add support for Android Intel x86_64 and Android ARM 64bit
