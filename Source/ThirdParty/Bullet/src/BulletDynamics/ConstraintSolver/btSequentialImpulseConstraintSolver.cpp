...
//		btScalar positionalError = 0.f;
        ...
        // Clockwork: possible friction fix from https://github.com/bulletphysics/bullet3/commit/907ac49892ede3f4a3295f7cbd96759107e5fc0e
...
btScalar btSequentialImpulseConstraintSolver::solveGroupCacheFriendlyFinish(btCollisionObject** bodies,int numBodies,const btContactSolverInfo& infoGlobal)
{
	...
	for (j=0;j<numPoolConstraints;j++)
	{
		...
		// Clockwork: if constraint has infinity breaking threshold, do not break no matter what
