...
// Clockwork: allow to disable SSE
#if (defined (CLOCKWORK_SSE) && defined (_WIN32) && (_MSC_VER) && _MSC_VER >= 1400) && (!defined (BT_USE_DOUBLE_PRECISION))
			#if _MSC_VER>1400
...
// Clockwork: allow to disable SSE
#if (defined (CLOCKWORK_SSE) && defined (__APPLE__) && (!defined (BT_USE_DOUBLE_PRECISION)))
