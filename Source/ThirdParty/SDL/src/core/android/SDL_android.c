...
// Clockwork: application files dir
...
// Clockwork: added passing user files directory from SDLActivity on startup
...
// Clockwork - function to return a list of files under a given path in "assets" directory (caller is responsible to free the C string array)
...
// Clockwork - helper function to free the file list returned by SDL_Android_GetFileList()
