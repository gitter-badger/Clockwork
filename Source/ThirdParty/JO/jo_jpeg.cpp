...
bool jo_write_jpg(const char *filename, const void *data, int width, int height, int comp, int quality) {
    ...
    unsigned char cheight = height>>8;
    unsigned char cheight2 = height&0xFF;
    unsigned char cwidth = width>>8;
    unsigned char cwidth2 = width&0xFF;
    const unsigned char head1[] = { 0xFF,0xC0,0,0x11,8,cheight,cheight2,cwidth,cwidth2,3,1,0x11,0,2,0x11,1,3,0x11,1,0xFF,0xC4,0x01,0xA2,0 };
