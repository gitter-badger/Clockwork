![Clockwork logo](https://raw.githubusercontent.com/dragonCASTjosh/Clockwork/master/bin/Data/Textures/LogoLarge.png)
...
terrain, water, smoke, flare and status bar textures from OGRE.
...
Documentation on how to build Clockwork:
  http://docs.sunwells.net_building.html
Documentation on how to use Clockwork as external library
  http://docs.sunwells.net_using_library.html
