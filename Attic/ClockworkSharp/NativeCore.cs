...
namespace ClockworkEngine
{
	...
	static class NativeCore
	{
		...
		public static T WrapNative<T> (IntPtr native) where T:RefCounted
		{
			...
			// instance id
			uint id = csb_Clockwork_RefCounted_GetRefID (native);
			...
			IntPtr classID = RefCounted.csb_Clockwork_RefCounted_GetClassID (native);
		...
		private static extern uint csb_Clockwork_RefCounted_GetRefID(IntPtr self);
