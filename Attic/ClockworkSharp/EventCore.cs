...
namespace ClockworkEngine
{
	...
	{		
		...
		private static extern IntPtr csb_Clockwork_VariantMap_GetInstance(IntPtr native, string key);
	...
	public static class EventCore
	{
		class Subscription
		{
			...
			public ClockworkEventDelegate Handler;			
		}
		...
		{
			csb_Clockwork_AObject_SendEvent (sender.nativeInstance, eventType);	
		}

		public static void SubscribeToEvent(AObject subscriber, AObject sender, string eventType, ClockworkEventDelegate function)
		{
			var eventTypeID = Clockwork.StringToStringHash (eventType);			
		...
		[DllImport (Constants.LIBNAME, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		private static extern void csb_Clockwork_AObject_SendEvent(IntPtr self, string eventType);
