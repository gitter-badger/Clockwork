...
class BunnyMark : ScriptObject
{
	...
	public BunnyMark ()
	{
		var player = Clockwork.GetSubsystem<Player> ();
		...
		var graphics = Clockwork.GetSubsystem<Graphics> ();
		var cache = Clockwork.GetSubsystem<ResourceCache> ();
...
class Spinner : CSComponent
{
	...
	override public void Start()
	{
		...
		var renderer = Clockwork.GetSubsystem<Renderer> ();
...
class MyGame
{
	...
	{		
		...
		Clockwork.RegisterAssemblyComponents (typeof(MyGame).Assembly);
