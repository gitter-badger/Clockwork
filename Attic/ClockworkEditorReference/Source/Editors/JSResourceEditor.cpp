    ...
    currentFindPos_(-1)
{
    ...
    CEJavascript* smjs = GetSubsystem<CEJavascript>();
    ...
    theme->themeColors[JSTHEME_LITERAL_NUMBER].SetFromString("#CE81FF", 7);
    theme->themeColors[JSTHEME_LITERAL_REGEX].SetFromString("#CE81FF", 7);
    theme->themeColors[JSTHEME_LITERAL_BOOLEAN].SetFromString("#CE81FF", 7);
    theme->themeColors[JSTHEME_LITERAL_NULL].SetFromString("#CE81FF", 7);
