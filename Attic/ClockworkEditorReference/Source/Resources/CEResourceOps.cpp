                                        ...
                                        bool navigateToResource, bool reportError)
{
    ...
    SharedPtr<File> srcFile = cache->GetFile("ClockworkEditor/templates/template_component.js");
    ...
    if (!CopyFile(srcFile, fullpath))
    {
        ...
        errorMsg.AppendWithFormat("Error copying template:\n\n%s\n\nto:\n\n%s",
                                  "ClockworkEditor/template_component.js", fullpath.CString());
        editor->PostModalError("Create Component Error", errorMsg);
        return;
    }
                                        ...
                                        bool navigateToResource, bool reportError)
{
    ...
    SharedPtr<File> srcFile = cache->GetFile("ClockworkEditor/templates/template_script.js");
    if (srcFile.Null() || !srcFile->IsOpen())
    {
    ...
    if (!CopyFile(srcFile, fullpath))
    {
        String errorMsg;
        errorMsg.AppendWithFormat("Error copying template:\n\n%s\n\nto:\n\n%s",
                                  "ClockworkEditor/template_script.js", fullpath.CString());
        editor->PostModalError("Create Script Error", errorMsg);
        return;
    }
