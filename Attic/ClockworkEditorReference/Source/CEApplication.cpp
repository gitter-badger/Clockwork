...
#include "Import/CEImportJSON.h"
#include "Import/CEJSONSceneProcess.h"
...
CEApplication::CEApplication(Context* context) :
    Application(context)
{

}

void CEApplication::Start()
{
    // refactor this
...
// END LICENSE MANAGEMENT
    ...
    editor->RequestPlatformChange(CE_PLATFORM_MAC);
#else
    editor->RequestPlatformChange(CE_PLATFORM_WINDOWS);
#endif
...
void CEApplication::Setup()
{
    ...
    CEPreferences::StartupPreferences prefs;
    if (CEPreferences::ReadStartupPrefs(context_, prefs))
    {
