    ...
    autorequest_(0), autocompartment_(0)
{
    ...
    *__global = JS_NewGlobalObject(jscontext_, &globalClass, nullptr,
    ...
    ExecuteFile("ClockworkEditor/javascript/modules/acorn_spidermonkey.js");
...
bool JSSpiderMonkeyVM::ParseJavascriptToJSON(const char* source, String& json)
{
    ...
    JS_CallFunctionName(jscontext_, *__global, "__clockwork_parse_to_json", HandleValueArray(jsource), &returnValue);
