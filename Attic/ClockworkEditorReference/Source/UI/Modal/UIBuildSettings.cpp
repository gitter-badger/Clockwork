    ...
    platformIndicator_(0)
{
    ...
    window_->SetText("Clockwork Player - Build Settings");
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/buildsettings.tb.txt");
...
void UIBuildSettings::UpdateCurrentPlatform(CEEditorPlatform platform)
{
