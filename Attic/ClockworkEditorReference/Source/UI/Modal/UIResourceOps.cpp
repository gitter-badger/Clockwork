    ...
    UIModalOpWindow(context)
{
    ...
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/resourcenewfolder.tb.txt");
    ...
    UIModalOpWindow(context)
{
    ...
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/resourcedelete.tb.txt");
    ...
    UIModalOpWindow(context)
{
    ...
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/resourcecreatecomponent.tb.txt");
    ...
    UIModalOpWindow(context)
{
    ...
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/resourcecreatescript.tb.txt");
    ...
    UIModalOpWindow(context)
{
    ...
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/resourcecreatemodule.tb.txt");
    ...
    UIModalOpWindow(context)
{
    ...
    tbui->LoadResourceFile(window_->GetContentRoot(), "ClockworkEditor/editor/ui/resourcecreate2dlevel.tb.txt");
