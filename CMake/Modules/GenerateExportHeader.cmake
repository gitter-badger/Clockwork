...
macro(_DO_SET_MACRO_VALUES TARGET_LIBRARY)
  ...
  # Clockwork: always generate header file regardless of target type
    if(WIN32)
...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  # Clockwork: CMake version less than 2.8.12 does not have this sub-command yet, so comment it out until the cmake minimum required is 2.8.12
  ...
  # Clockwork: Our revised version does not depend on the target to be added first, so always derive the variable value from target name instead
...
# Clockwork: revise to pass the library type by argument so that it does not depend on the target to be added first
