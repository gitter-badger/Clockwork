...
if (NOT WIN32 OR CLOCKWORK_OPENGL OR DIRECT3D_FOUND)
    return ()
endif ()

# Prefer to use MS Windows SDK, so search for it first
if (MINGW)
    # Assume that 'libd3dcompiler.a' is a symlink pointing to 'libd3dcompiler_46.a' (See this discussion http://clockwork3d.prophpbb.com/topic504.html)
...
elseif (MSVC_VERSION LESS 1700 OR NOT CLOCKWORK_D3D11)
