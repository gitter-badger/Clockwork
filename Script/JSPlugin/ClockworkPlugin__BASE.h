...
// --------------------
// BEGIN ClockworkPlugin.h
// --------------------

#ifndef CLOCKWORK_PLUGIN_H
#define CLOCKWORK_PLUGIN_H
...
#ifdef CLOCKWORK_PLUGIN_MAIN

#define CLOCKWORK_JSPLUGIN_VERSION 1
...
extern "C"
{
    ...
    bool PLUGIN_EXPORT_API clockwork_plugin_validate(int version, void *jsvmImports, size_t jsvmImportsSize)
    {
        if (version != CLOCKWORK_JSPLUGIN_VERSION)
            return false;
...
#endif //CLOCKWORK_PLUGIN_MAIN

#endif // CLOCKWORK_PLUGIN_H
