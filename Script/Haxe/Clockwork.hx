...
extern class Clockwork {
    ...
    public static var NUM_FRUSTUM_PLANES: UInt;
    public static var NUM_FRUSTUM_VERTICES: UInt;
    public static var M_PI: Float;
    public static var M_HALF_PI: Float;
    public static var M_MIN_INT: Int;
    public static var M_MAX_INT: Int;
    public static var M_MIN_UNSIGNED: UInt;
    public static var M_MAX_UNSIGNED: UInt;
    public static var M_EPSILON: Float;
    public static var M_LARGE_EPSILON: Float;
    public static var M_MIN_NEARCLIP: Float;
    public static var M_MAX_FOV: Float;
    public static var M_LARGE_VALUE: Float;
    public static var M_INFINITY: Float;
    public static var M_DEGTORAD: Float;
    public static var M_DEGTORAD_2: Float;
    public static var M_RADTODEG: Float;


    public static var AM_EDIT: UInt;
    public static var AM_FILE: UInt;
    public static var AM_NET: UInt;
    public static var AM_DEFAULT: UInt;
    public static var AM_LATESTDATA: UInt;
    public static var AM_NOEDIT: UInt;
    public static var AM_NODEID: UInt;
    public static var AM_COMPONENTID: UInt;
    public static var AM_NODEIDVECTOR: UInt;


    public static var USE_UPDATE: UInt;
    public static var USE_POSTUPDATE: UInt;
    public static var USE_FIXEDUPDATE: UInt;
    public static var USE_FIXEDPOSTUPDATE: UInt;
    public static var MAX_NETWORK_ATTRIBUTES: UInt;
    public static var FIRST_REPLICATED_ID: UInt;
    public static var LAST_REPLICATED_ID: UInt;
    public static var FIRST_LOCAL_ID: UInt;
    public static var LAST_LOCAL_ID: UInt;
    public static var SMOOTH_NONE: UInt;
    public static var SMOOTH_POSITION: UInt;
    public static var SMOOTH_ROTATION: UInt;


    public static var DEFAULT_NEARCLIP: Float;
    public static var DEFAULT_FARCLIP: Float;
    public static var DEFAULT_CAMERA_FOV: Float;
    public static var DEFAULT_ORTHOSIZE: Float;
    public static var VO_NONE: UInt;
    public static var VO_LOW_MATERIAL_QUALITY: UInt;
    public static var VO_DISABLE_SHADOWS: UInt;
    public static var VO_DISABLE_OCCLUSION: UInt;
    public static var DRAWABLE_GEOMETRY: UInt;
    public static var DRAWABLE_LIGHT: UInt;
    public static var DRAWABLE_ZONE: UInt;
    public static var DRAWABLE_GEOMETRY2D: UInt;
    public static var DRAWABLE_ANY: UInt;
    public static var DEFAULT_VIEWMASK: UInt;
    public static var DEFAULT_LIGHTMASK: UInt;
    public static var DEFAULT_SHADOWMASK: UInt;
    public static var DEFAULT_ZONEMASK: UInt;
    public static var MAX_VERTEX_LIGHTS: Int;
    public static var ANIMATION_LOD_BASESCALE: Float;
    ...
    public static var CLEAR_COLOR: UInt;
    public static var CLEAR_DEPTH: UInt;
    public static var CLEAR_STENCIL: UInt;
    public static var MASK_NONE: UInt;
    public static var MASK_POSITION: UInt;
    public static var MASK_NORMAL: UInt;
    public static var MASK_COLOR: UInt;
    public static var MASK_TEXCOORD1: UInt;
    public static var MASK_TEXCOORD2: UInt;
    public static var MASK_CUBETEXCOORD1: UInt;
    public static var MASK_CUBETEXCOORD2: UInt;
    public static var MASK_TANGENT: UInt;
    public static var MASK_BLENDWEIGHTS: UInt;
    public static var MASK_BLENDINDICES: UInt;
    public static var MASK_INSTANCEMATRIX1: UInt;
    public static var MASK_INSTANCEMATRIX2: UInt;
    public static var MASK_INSTANCEMATRIX3: UInt;
    public static var MASK_DEFAULT: UInt;
    public static var NO_ELEMENT: UInt;
    ...
    public static var OCCLUSION_X_SCALE: Float;
    public static var OCCLUSION_Z_SCALE: Float;
    public static var NUM_OCTANTS: Int;
    public static var ROOT_INDEX: UInt;
    public static var SHADOW_MIN_PIXELS: Int;
    public static var INSTANCING_BUFFER_DEFAULT_SIZE: Int;
    public static var MAX_VIEWPORT_TEXTURES: UInt;
    public static var MAX_TEXTURE_QUALITY_LEVELS: Int;


    public static var CHANNEL_POSITION: UInt;
    public static var CHANNEL_ROTATION: UInt;
    public static var CHANNEL_SCALE: UInt;
    public static var MAX_BILLBOARDS: UInt;
    public static var MODEL_VERSION: UInt;
    public static var DEFAULT_NUM_PARTICLES: UInt;
    public static var BONECOLLISION_NONE: UInt;
    public static var BONECOLLISION_SPHERE: UInt;
    public static var BONECOLLISION_BOX: UInt;


    public static var PIXEL_SIZE: Float;


    public static var STREAM_BUFFER_LENGTH: Int;


    public static var DEFAULT_MAX_NETWORK_ANGULAR_VELOCITY: Float;
    ...
    public static var UI_VERTEX_SIZE: UInt;


    public static var COLOR_LUT_SIZE: Int;
    public static var PRIORITY_LAST: UInt;
    ...
    public static var CONTROLS_CONTENT_ID: UInt;
    public static var PACKAGE_FRAGMENT_SIZE: UInt;


    public static var SCAN_FILES: UInt;
    public static var SCAN_DIRS: UInt;
    public static var SCAN_HIDDEN: UInt;
...
extern class AObject extends RefCounted {
    ...
    function unsubscribeFromEvent(eventType: String): Void;
...
extern class Node extends Animatable {
    ...
    function setScale(scale: Vector3): Void;
      // Set scale in parent space (for Clockwork2D).
    ...
    function setWorldRotation(rotation: Quaternion): Void;
      // Set rotation in world space (for Clockwork2D).
    ...
    function translate(delta: Vector3, ?space: TransformSpace): Void;
      // Move the scene node in the chosen transform space (for Clockwork2D).
    ...
    function rotate(delta: Quaternion, ?space: TransformSpace): Void;
      // Rotate the scene node in the chosen transform space (for Clockwork2D).
    ...
    function rotateAround(point: Vector3, delta: Quaternion, ?space: TransformSpace): Void;
      // Rotate around a point in the chosen transform space (for Clockwork2D).
    ...
    function getPosition(): Vector3;
      // Return position in parent space (for Clockwork2D).
    function getPosition2D(): Vector2;
      // Return rotation in parent space.
    function getRotation(): Quaternion;
      // Return rotation in parent space (for Clockwork2D).
    ...
    function getWorldScale(): Vector3;
      // Return scale in world space (for Clockwork2D).
    function getWorldScale2D(): Vector2;
      // Convert a local space position or rotation to world space (for Clockwork2D).
    function localToWorld2D(vector: Vector2): Vector2;
      // Convert a world space position or rotation to local space (for Clockwork2D).
...
@:native("Clockwork.ObjectAnimation")
...
@:native("Clockwork.PrefabComponent")
...
@:native("Clockwork.SmoothedTransform")
...
@:native("Clockwork.ValueAnimation")
...
@:native("Clockwork.ValueAnimationInfo")
...
@:native("Clockwork.DebugRenderer")
...
@:native("Clockwork.ShaderPrecache")
...
extern class Graphics extends AObject {
    ...
    function setWindowPosition(x: Int, y: Int): Void;
      // Set window size.
    ...
    function getNumMonitors(): Int;
      // Return true if window is maximized
    function getMaximized(): Bool;
      // Return monitor resolution
    function getMonitorResolution(monitorId: Int): IntVector2;

}

@:native("Clockwork.RenderSurface")
...
@:native("Clockwork.ShaderVariation")
...
@:native("Clockwork.AnimatedModel")
...
@:native("Clockwork.AnimationController")
...
@:native("Clockwork.AnimationState")
...
extern class Billboard extends RefCounted {
    ...
    function getSortDistance(): Float;
    function setSortDistance(sortDistance: Float): Void;

}

@:native("Clockwork.BillboardSet")
...
@:native("Clockwork.CustomGeometry")
...
@:native("Clockwork.Model")
extern class Model extends Resource {

    var boundingBox: BoundingBox;
    var numGeometries: UInt;
    var numMorphs: UInt;
    var geometryNames: Array<String>;
    ...
    function setGeometryName(index: UInt, name: String): Bool;
    function getGeometryName(index: UInt): String;
    function getGeometryNames(): Array<String>;

}

@:native("Clockwork.ParticleEffect")
...
@:native("Clockwork.ParticleEmitter")
...
extern class StaticModel extends Drawable {
    ...
    function getGeometryVisible(name: String): Bool;
      // Show a named submesh
    function showGeometry(name: String): Void;
      // Hide a named submesh
    function hideGeometry(name: String): Void;
      function setMaterialIndex(index:UInt, material:Material):Void;

}

@:native("Clockwork.StaticModelGroup")
...
@:native("Clockwork.AnimatedSprite2D")
...
@:native("Clockwork.AnimationSet2D")
...
@:native("Clockwork.CollisionBox2D")
...
@:native("Clockwork.CollisionChain2D")
...
@:native("Clockwork.CollisionCircle2D")
...
@:native("Clockwork.CollisionEdge2D")
...
@:native("Clockwork.CollisionPolygon2D")
...
@:native("Clockwork.CollisionShape2D")
...
@:native("Clockwork.ConstraintDistance2D")
...
@:native("Clockwork.ConstraintFriction2D")
...
@:native("Clockwork.ConstraintGear2D")
...
@:native("Clockwork.ConstraintMotor2D")
...
@:native("Clockwork.ConstraintMouse2D")
...
@:native("Clockwork.ConstraintPrismatic2D")
...
@:native("Clockwork.ConstraintPulley2D")
...
@:native("Clockwork.ConstraintRevolute2D")
...
@:native("Clockwork.ConstraintRope2D")
...
@:native("Clockwork.ConstraintWeld2D")
...
@:native("Clockwork.ConstraintWheel2D")
...
@:native("Clockwork.DirectionalLight2D")
...
@:native("Clockwork.PositionalLight2D")
...
@:native("Clockwork.ParticleEffect2D")
...
@:native("Clockwork.ParticleEmitter2D")
...
@:native("Clockwork.PhysicsWorld2D")
...
@:native("Clockwork.SpriteSheet2D")
...
@:native("Clockwork.StaticSprite2D")
...
@:native("Clockwork.PropertySet2D")
...
@:native("Clockwork.TileMapObject2D")
...
@:native("Clockwork.TileMapLayer2D")
...
@:native("Clockwork.TmxTileLayer2D")
...
@:native("Clockwork.TmxObjectGroup2D")
...
@:native("Clockwork.TmxImageLayer2D")
...
@:native("Clockwork.SoundListener")
...
@:native("Clockwork.SoundSource3D")
...
@:native("Clockwork.CollisionShape")
...
extern class RigidBody extends Component {
    ...
    function setRotation(rotation: Quaternion): Void;
      // Set rigid body position and rotation in world space as an clockwork operation.
    function setTransform(position: Vector3, rotation: Quaternion): Void;
      // Set linear velocity.
...
@:native("Clockwork.NavigationMesh")
...
@:native("Clockwork.OffMeshConnection")
...
extern class Input extends AObject {
    ...
    function bindButton(touchButton: UIButton, button: Int): Void;
    function simulateButtonDown(button: Int): Void;
    function simulateButtonUp(button: Int): Void;
...
@:native("Clockwork.UI")
extern class UI extends AObject {

    var keyboardDisabled: Bool;
    var inputDisabled: Bool;
    var skinLoaded: Bool;
    var focusedWidget: Bool;
    var blockChangedEvents: Bool;
    var hoveredWidget: UIWidget;

      // Construct.
    function new();

    function setKeyboardDisabled(disabled: Bool): Void;
    function setInputDisabled(disabled: Bool): Void;
    function render(?resetRenderTargets: Bool): Void;
    function initialize(languageFile: String): Void;
    ...
    function getFocusedWidget(): Bool;
      // request exit on next frame
    function requestExit(): Void;
    function getWidgetAt(x: Int, y: Int, include_children: Bool): UIWidget;
    function getBlockChangedEvents(): Bool;
    function setBlockChangedEvents(?blocked: Bool): Void;
    function getHoveredWidget(): UIWidget;
    function debugShowSettingsWindow(parent: UIWidget): Void;

}

@:native("Clockwork.UIButton")
extern class UIButton extends UIWidget {

    var squeezable: Bool;
    var emulationButton: Int;
    var urlEnabled: Bool;
    ...
    function setEmulationButton(button: Int): Void;
      // for example a http:// link will open the default browser
    function setURLEnabled(enabled: Bool): Void;

}

@:native("Clockwork.UICheckBox")
...
@:native("Clockwork.UIFontDescription")
...
@:native("Clockwork.UIImageWidget")
...
@:native("Clockwork.UIInlineSelect")
...
@:native("Clockwork.UILayoutParams")
...
extern class UILayout extends UIWidget {
    ...
    @:overload(function(axis: UI_AXIS): Void{})
    override function setAxis(axis: UI_AXIS): Void;
...
extern class UIListView extends UIWidget {
    ...
    function getExpanded(itemID: UInt): Bool;
    function getExpandable(itemID: UInt): Bool;
    function getMultiSelect(): Bool;
    function setMultiSelect(value: Bool): Void;
    function deleteAllItems(): Void;
    function selectItemByID(id: String, ?selected: Bool): Void;
    function getHoverItemID(): String;
    function getSelectedItemID(): String;
    function getRootList(): UISelectList;
    function updateItemVisibility(): Void;
    function selectAllItems(?select: Bool): Void;

}

@:native("Clockwork.UIMenuItem")
...
@:native("Clockwork.UIMenuItemSource")
...
@:native("Clockwork.UIMessageWindow")
...
@:native("Clockwork.UIPreferredSize")
...
@:native("Clockwork.UIScrollContainer")
...
@:native("Clockwork.UISelectDropdown")
...
@:native("Clockwork.UISelectItemSource")
...
extern class UISelectList extends UIWidget {
    ...
    override function getValue(): Float;
    function getHoverItemID(): String;
    function getSelectedItemID(): String;
    function scrollToSelectedItem(): Void;
    function getItemID(index: Int): String;
    function getItemSelected(index: Int): Bool;
    function getNumItems(): Int;
    function selectItem(index: Int, ?selected: Bool): Void;
    function selectNextItem(): Void;
    function selectPreviousItem(): Void;
    function setUIListView(value: Bool): Void;

}

@:native("Clockwork.UISeparator")
...
extern class UITabContainer extends UIWidget {
    ...
    function getTabLayout(): UILayout;

}

@:native("Clockwork.UITextField")
...
@:native("Clockwork.UITextureWidget")
...
extern class UIWidget extends AObject {
    ...
    function addChildAfter(child: UIWidget, otherChild: UIWidget): Void;
    function addChildBefore(child: UIWidget, otherChild: UIWidget): Void;
    ...
    function setDelegate(widget: UIWidget): Void;
    function setMultiTouch(multiTouch: Bool): Void;
    function isMultiTouch(): Bool;
    function getCaptured(): Bool;
    function setCapturing(capturing: Bool): Void;
    function getCapturing(): Bool;
    function invokeShortcut(shortcut: String): Void;
    function getShortened(): Bool;
    function setShortened(shortened: Bool): Void;
...
@:native("Clockwork.ResourceCache")
...
@:native("Clockwork.NetworkPriority")
...
@:native("Clockwork.BufferQueue")
extern class BufferQueue extends AObject {
...
extern class Engine extends AObject {
    ...
    function setRunNextPausedFrame(run: Bool): Void;
    ...
    function getRunNextPausedFrame(): Bool;
...
@:native("Clockwork.ScriptComponent")
extern class ScriptComponent extends Component {

    var componentClassName: String;
    var componentFile: ScriptComponentFile;

      // Construct.
    function new();

    function getComponentClassName(): String;
    function getComponentFile(): ScriptComponentFile;

}

@:native("Clockwork.ScriptComponentFile")
extern class ScriptComponentFile extends Resource {
...
@:native("Clockwork.JSComponent")
extern class JSComponent extends ScriptComponent {
    ...
    @:overload(function(): ScriptComponentFile{})
    override function getComponentFile(): ScriptComponentFile;
...
@:native("Clockwork.JSComponentFile")
extern class JSComponentFile extends ScriptComponentFile {
...
@:native("Clockwork.JSEventHelper")
...
@:native("Clockwork.Web")
extern class Web extends AObject {

      // Construct.
    function new();

      // Perform an HTTP request to the specified URL. Empty verb defaults to a GET request. Return a request object which can be used to read the response data.
    function makeWebRequest(verb: String, url: String, ?requestContentSize: Float): WebRequest;
...
@:native("Clockwork.WebRequest")
extern class WebRequest extends AObject {

    var url: String;
    var error: String;
    var state: WebRequestState;
    var verb: String;
    var allResponseHeaders: String;

      // Construct with parameters.
    function new(verb: String, url: String, requestContentSize: Float);
    ...
    function getError(): String;
      // Return connection state.
    function getState(): WebRequestState;
    ...
    function hasDownloadChunkEvent(): Bool;
...
@:native("Clockwork.WebSocket")
extern class WebSocket extends AObject {
