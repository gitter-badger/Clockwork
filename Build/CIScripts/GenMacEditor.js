...
namespace('build', function() {
  ...
  task('genmaceditorinstaller', ["genmaceditor"], {
    async: true
      ...
      "codesign --force --verify --verbose --sign \"Developer ID Application: CLOCKWORK STUDIOS (C7M5MAQQWR)\" " + editorAppFolder + "/Contents/Frameworks/ClockworkEditor\\ Helper.app",
      "codesign --force --verify --verbose --sign \"Developer ID Application: CLOCKWORK STUDIOS (C7M5MAQQWR)\" " + editorAppFolder + "/Contents//Frameworks/ClockworkEditor\\ Helper\\ EH.app",
      "codesign --force --verify --verbose --sign \"Developer ID Application: CLOCKWORK STUDIOS (C7M5MAQQWR)\" " + editorAppFolder + "/Contents/Frameworks/ClockworkEditor\\ Helper\\ NP.app",
      "codesign --force --verify --verbose --sign \"Developer ID Application: CLOCKWORK STUDIOS (C7M5MAQQWR)\" " + editorAppFolder + "/Contents/Frameworks/Chromium\\ Embedded\\ Framework.framework",
      "codesign --force --verify --verbose --sign \"Developer ID Application: CLOCKWORK STUDIOS (C7M5MAQQWR)\" " + editorAppFolder,      
