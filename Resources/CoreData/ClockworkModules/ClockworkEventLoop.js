 ...
 *  CHANGES
 *  TSH - August 2015
 *      - Removed EventLoop.run as it was looking at Sockets which Clockwork doesn't provide.  Now, this subscribes to the Clockwork.engine.update/afterUpdate events to process the timers.
...
Clockwork.engine.subscribeToEvent('Update', throttleProcessTimers(100));
...
Clockwork.engine.subscribeToEvent('PostUpdate', function (eventData) {
